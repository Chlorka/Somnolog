...
?>
<div class="all-form">
    <p class="h2"><span>Оставьте свой отзыв</span></p>
<?
...
<?*/?>
    ...
    <input name="iblock_id"  type="hidden" value="<?=$arParams["IBLOCK_ID"]?>">
    <input name="only"  type="hidden" value="<?=$arParams["IBLOCK_ID"]?>">
    <input type="submit" name="iblock_submit" value="Разместить отзыв" />
    <?if (strlen($arParams["LIST_URL"]) > 0):?>
        <input type="submit" name="iblock_apply" value="<?=GetMessage("IBLOCK_FORM_APPLY")?>" />
        <input
            type="button"
