...
<form class="form_send"
	...
	<?if($propertyID=='PREVIEW_TEXT'):?>
		...
		<?endif?>
    <div class="ww-grid">
        <p class="ww-sub-text">ћы перезвоним вам в течении<br>
            часа рабочего времени и согласуем заказ</p>
        <input name="only" value="main" type="hidden">
        <input name="iblock_id"  type="hidden" value="<?=$arParams["IBLOCK_ID"]?>">
        <input type="submit" name="iblock_submit" value="«аказать цемент" />
